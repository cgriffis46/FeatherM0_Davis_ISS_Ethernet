...
#define COUNT_RF69_MODES		 6 // Number of distinct radio modes (for stats tracking)
#define RF69_MODE_LISTEN     5
...
class DavisRFM69 {
  public:
    ...
    TaskHandle_t xReadRadioTaskHandle = NULL;
  ...
  volatile bool ModeReady = false;
    ...
    void select(bool FromISR = false);
    void unselect(bool FromISR = false);
